...
function AdminBulkImageUpload({ onBack }) {
  ...
  function parseCsvStatic(text) {
    ...
    return lines.slice(1).map(line => {
      ...
      return { productName: r.productname||r.product||r.name||"", brand: r.brand||"", imageUrl: r.imageurl||r.image||r.url||"", ingredients: r.ingredients||"", category: r.category||"", skinTypes: r.skintypes||r.skintype||"", buyUrl: r.buyurl||r.buy||"", barcode: r.barcode||"", reason: r.reason||"" };
...
// ── Nuclear Clean ───────────────────────────────────────────────────────────
// Compact seed data for nuclear clean (~39KB instead of 172KB)
function getNuclearSeedProducts() {
  return [{"n": "SA Smoothing Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "All", "r": "Daily facial cleanser by CeraVe"}, {"n": "Hydrating Foaming Oil Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "All", "r": "Daily facial cleanser by CeraVe"}, {"n": "C-Firma™ Vitamin C Day Serum", "b": "Drunk Elephant", "c": "Serum", "s": "Dull", "r": "Vitamin C — antioxidant brightening and dark spot correction"}, {"n": "Pantene Active Nutri-Plex Smooth & Sleek Conditioner|Balsam Rinse Off or Leave-On", "b": "Pantene", "c": "Hair", "s": "All", "r": "Hair care by Pantene"}, {"n": "Vanicream Moisturizing Lotion", "b": "Vanicream", "c": "Moisturiser", "s": "All", "r": "Daily moisturiser by Vanicream"}, {"n": "Foaming Facial Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "All", "r": "Daily facial cleanser by CeraVe"}, {"n": "Crystal Tears Serum &quot;The power of youth&quot;", "b": "Mira Dror", "c": "Serum", "s": "All", "r": "Treatment serum by Mira Dror"}, {"n": "Moisturizing Cream", "b": "CeraVe", "c": "Moisturiser", "s": "Dry,Normal,Sensitive", "r": "Non-pore-clogging, ceramide-rich"}, {"n": "CeraVe Moisturizing Cream", "b": "CeraVe", "c": "Moisturiser", "s": "All", "r": "Skincare product by CeraVe"}, {"n": "30% AHA + 2% BHA Exfoliating Peel Pads", "b": "Dr. Dennis Gross", "c": "Toner", "s": "Acne-prone,Oily", "r": "Skincare product by Dr. Dennis Gross"}, {"n": "Vanicream Daily Facial Moisturizer", "b": "Vanicream", "c": "Moisturiser", "s": "All", "r": "Skincare product by Vanicream"}, {"n": "Superfood Cleanser", "b": "Youth To The People", "c": "Face Wash", "s": "All", "r": "Skincare product by Youth To The People"}, {"n": "Skin Perfecting 2% BHA Liquid Exfoliant", "b": "Paula's Choice", "c": "Toner", "s": "Oily,Acne-prone,Combination", "r": "Unclogs pores, smooths texture"}, {"n": "Acne Free Terminator 10 Spot Treatment", "b": "AcneFree", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Maximum strength 10% benzoyl peroxide spot treatment"}, {"n": "Omega Rich Rescue Cream", "b": "Alpyn Beauty", "c": "Moisturiser", "s": "Dry,Sensitive,Acne-prone", "r": "Wild-harvested cloudberry + omegas, no pore-clogging oils"}, {"n": "Salicylic Acid Cleanser", "b": "Alpyn Beauty", "c": "Face Wash", "s": "Acne-prone,Oily,Combination", "r": "Wild-harvested botanicals + 0.5% salicylic acid, acne-safe"}, {"n": "Skin Relief Moisture Repair Cream", "b": "Aveeno", "c": "Body", "s": "Dry,Sensitive,Eczema", "r": "Oat + ceramides, fragrance-free body cream"}, {"n": "Aqua Bomb", "b": "Belif", "c": "Moisturiser", "s": "Oily,Combination,Normal", "r": "Lady's mantle herb water-burst gel, no pore-cloggers"}, {"n": "Sensibio H2O Micellar Water", "b": "Bioderma", "c": "Toner", "s": "Sensitive,All", "r": "Cult micellar water, removes makeup without rinsing"}, {"n": "Squalane + Antioxidant Cleansing Oil", "b": "Biossance", "c": "Face Wash", "s": "Dry,Normal,Sensitive", "r": "Squalane-based cleansing oil — no mineral oil, no coconut oil"}, {"n": "Squalane + Phyto-Retinol Serum", "b": "Biossance", "c": "Serum", "s": "All,Mature,Acne-prone", "r": "Bakuchiol (plant retinol) + squalane — retinol benefits without irritation"}, {"n": "Squalane + Probiotic Moisturizer", "b": "Biossance", "c": "Moisturiser", "s": "All,Acne-prone,Sensitive", "r": "Sugarcane-derived squalane, zero pore-cloggers, microbiome-friendly"}, {"n": "Acne Control Gel", "b": "CeraVe", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Skincare product by CeraVe"}, {"n": "Acne Foaming Cream Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "Acne-prone,Oily", "r": "4% benzoyl peroxide + ceramides, gentle on skin barrier"}, {"n": "AM Facial Moisturizing Lotion SPF 30", "b": "CeraVe", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 30 — daily UV protection"}, {"n": "Eye Repair Cream", "b": "CeraVe", "c": "Eye Cream", "s": "Sensitive", "r": "Ceramides + niacinamide, reduces dark circles and puffiness"}, {"n": "Hydrating Facial Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "All", "r": "Ceramide-rich, fragrance-free, zero pore-cloggers"}, {"n": "Hydrating Hyaluronic Acid Serum", "b": "CeraVe", "c": "Serum", "s": "All", "r": "Hyaluronic acid — deep hydration and plumping for all skin types"}, {"n": "Mineral Sunscreen SPF 50", "b": "CeraVe", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "PM Facial Moisturizing Lotion", "b": "CeraVe", "c": "Moisturiser", "s": "All", "r": "Skincare product by CeraVe"}, {"n": "Renewing SA Cleanser", "b": "CeraVe", "c": "Face Wash", "s": "All", "r": "Salicylic acid + ceramides — exfoliating without stripping"}, {"n": "Resurfacing Retinol Serum", "b": "CeraVe", "c": "Serum", "s": "Ageing", "r": "Retinol — anti-ageing, smooths texture and reduces fine lines"}, {"n": "Skin Renewing Vitamin C Serum", "b": "CeraVe", "c": "Serum", "s": "Dull", "r": "Vitamin C — antioxidant brightening and dark spot correction"}, {"n": "Bright Healthy Radiance Serum", "b": "Cetaphil", "c": "Serum", "s": "Dull", "r": "Skincare product by Cetaphil"}, {"n": "Daily Facial Moisturizer SPF 35", "b": "Cetaphil", "c": "SPF", "s": "All", "r": "Skincare product by Cetaphil"}, {"n": "Gentle Skin Cleanser", "b": "Cetaphil", "c": "Face Wash", "s": "Sensitive", "r": "Dermatologist #1 recommended, fragrance-free"}, {"n": "Hydrating Eye Gel-Cream", "b": "Cetaphil", "c": "Eye Cream", "s": "All", "r": "Skincare product by Cetaphil"}, {"n": "Oil Control Foam Wash", "b": "Cetaphil", "c": "Face Wash", "s": "Acne-prone,Oily", "r": "Skincare product by Cetaphil"}, {"n": "Pro Oil Removing Foam Wash", "b": "Cetaphil", "c": "Face Wash", "s": "All", "r": "Skincare product by Cetaphil"}, {"n": "Redness Relieving Daily Facial Moisturizer SPF 20", "b": "Cetaphil", "c": "SPF", "s": "All", "r": "Skincare product by Cetaphil"}, {"n": "Acne Body Wash", "b": "Clearstem", "c": "Acne Treatment", "s": "Acne-prone,Body", "r": "Acne-safe body wash — salicylic acid + stem cells, no pore-cloggers"}, {"n": "BOUNCEBACK Hyaluronic Acid Moisturizer", "b": "Clearstem", "c": "Moisturiser", "s": "All", "r": "Hyaluronic acid — deep hydration and plumping for all skin types"}, {"n": "Brightening Serum", "b": "Clearstem", "c": "Serum", "s": "All,Dull,Post-acne,Acne-prone", "r": "100% acne-safe brightening serum — fades marks without clogging"}, {"n": "CELLRENEW Microneedling Collagen Serum", "b": "Clearstem", "c": "Serum", "s": "Ageing", "r": "Skincare product by Clearstem"}, {"n": "CELLRENEW Stem Cell Mask", "b": "Clearstem", "c": "Mask", "s": "All,Acne-prone,Mature", "r": "Stem cell technology in a 100% acne-safe mask formula"}, {"n": "CELLRENEW Stem Cell Moisturizer", "b": "Clearstem", "c": "Moisturiser", "s": "All,Acne-prone,Mature", "r": "100% acne-safe moisturizer with stem cell technology and growth factors"}, {"n": "CLEARITY Targeted Skin Clearing Serum", "b": "Clearstem", "c": "Serum", "s": "All", "r": "Skincare product by Clearstem"}, {"n": "CLEARSTEM BOUNCEBACK Post-Breakout Serum", "b": "Clearstem", "c": "Acne Treatment", "s": "Post-acne,Acne-prone,All", "r": "Fades post-acne marks fast — stem cells + niacinamide, 100% acne-safe"}, {"n": "CLEARSTEM CLARIFY Acne Serum", "b": "Clearstem", "c": "Acne Treatment", "s": "Acne-prone,All", "r": "Stem cell + salicylic acid — targets acne without drying"}, {"n": "CLEARSTEM CLEARBODY Acne Spray", "b": "Clearstem", "c": "Body", "s": "Acne-prone,Body", "r": "Hard-to-reach back acne spray — salicylic + stem cells, 100% acne-safe"}, {"n": "CLEARSTEM MINSCAPE Retinol Serum", "b": "Clearstem", "c": "Serum", "s": "Acne-prone,Mature,All", "r": "Acne-safe retinol — no pore-cloggers in the base, stem cells enhance results"}, {"n": "DEWGLOW Mineral Sunscreen SPF 30", "b": "Clearstem", "c": "SPF", "s": "Dull", "r": "Broad-spectrum SPF 30 — daily UV protection"}, {"n": "CLEARITY The Blackhead Dissolver Mandelic Acid Serum", "b": "Clearstem", "c": "Serum", "s": "All,Dull,Acne-prone", "r": "Acne-safe vitamin C — brightens without pore-cloggers"}, {"n": "Even Up Clinical Pigment Perfector SPF 50", "b": "Colorescience", "c": "SPF", "s": "Dull", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Sunforgettable Total Protection Face Shield Flex SPF 50", "b": "Colorescience", "c": "SPF", "s": "All,Post-acne,Redness", "r": "Tinted mineral SPF 50 with optical blurring — corrects redness and spots"}, {"n": "Mineral Eye Cream SPF 35", "b": "Colorescience", "c": "SPF", "s": "All,Sensitive", "r": "Mineral SPF + peptides for the eye area, no pore-cloggers"}, {"n": "Pep Up Collagen Renew Serum", "b": "Colorescience", "c": "Serum", "s": "Ageing", "r": "Skincare product by Colorescience"}, {"n": "Sunforgettable Total Protection Brush-On Shield SPF 50", "b": "Colorescience", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Sunforgettable Total Protection Face Shield SPF 50", "b": "Colorescience", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Sunforgettable Total Protection SPF 50", "b": "Colorescience", "c": "SPF", "s": "All,Sensitive,Acne-prone", "r": "100% mineral, reef-safe, acne-safe powder SPF"}, {"n": "Total Eye 3-in-1 Renewal Therapy SPF 35", "b": "Colorescience", "c": "Eye Cream", "s": "All", "r": "Mineral SPF + peptides + colour correction for eyes"}, {"n": "Total Protection Face Shield SPF 50+", "b": "Colorescience", "c": "SPF", "s": "All,Sensitive,Acne-prone", "r": "Broad spectrum mineral SPF 50+ — pollution shield, non-comedogenic"}, {"n": "Acne Pimple Master Patch", "b": "COSRX", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Skincare product by COSRX"}, {"n": "AHA 7 Whitehead Power Liquid", "b": "COSRX", "c": "Toner", "s": "All", "r": "Skincare product by COSRX"}, {"n": "AHA/BHA Clarifying Treatment Toner", "b": "COSRX", "c": "Toner", "s": "Oily,Acne-prone,Combination", "r": "Willow bark BHA + glycolic AHA dual-acid daily toner"}, {"n": "BHA Blackhead Power Liquid", "b": "COSRX", "c": "Toner", "s": "Acne-prone,Oily", "r": "4% betaine salicylate — clears blackheads, gentler than traditional BHA"}, {"n": "Galactomyces 95 Tone Balancing Essence", "b": "COSRX", "c": "Toner", "s": "All", "r": "Galactomyces 95% — brightening and pore-minimising essence"}, {"n": "Low pH Good Morning Gel Cleanser", "b": "COSRX", "c": "Face Wash", "s": "All", "r": "pH 5.0 preserves acid mantle, BHA-boosted"}, {"n": "Oil-Free Ultra Moisturizing Lotion", "b": "COSRX", "c": "Moisturiser", "s": "Acne-prone,Oily", "r": "Skincare product by COSRX"}, {"n": "Propolis Light Ampule", "b": "COSRX", "c": "Serum", "s": "All", "r": "Propolis — antioxidant-rich brightening and healing ampoule"}, {"n": "Pure Fit Cica Serum", "b": "COSRX", "c": "Serum", "s": "Sensitive", "r": "Cica (centella) — calming redness and repairing skin barrier"}, {"n": "Daily Microfoliant", "b": "Dermalogica", "c": "Face Wash", "s": "All,Sensitive,Acne-prone", "r": "Rice-based enzyme powder exfoliant — brightens without irritating"}, {"n": "Cica Repair Cream Mask", "b": "Dr. Jart+", "c": "Mask", "s": "Sensitive,Acne-prone,Irritated", "r": "Centella asiatica repairs and calms — no pore-cloggers"}, {"n": "Cicapair Tiger Grass Color Correcting Treatment", "b": "Dr. Jart+", "c": "Moisturiser", "s": "Sensitive,Redness,All", "r": "Centella asiatica calms redness, SPF 30, non-comedogenic"}, {"n": "A-Passioni Retinol Cream", "b": "Drunk Elephant", "c": "Serum", "s": "Ageing", "r": "1% vegan retinol in a non-comedogenic base — smoothing and resurfacing"}, {"n": "B-Hydra Intensive Hydration Serum", "b": "Drunk Elephant", "c": "Serum", "s": "All", "r": "Pro-vitamin B5 + pineapple ceramide — weightless hydration serum"}, {"n": "Beste No. 9 Jelly Cleanser", "b": "Drunk Elephant", "c": "Face Wash", "s": "All", "r": "Gentle jelly cleanser — removes makeup and SPF without stripping, zero pore-clog"}, {"n": "Body Lochi Hydrating Milk", "b": "Drunk Elephant", "c": "Body", "s": "All,Dry,Sensitive", "r": "Lightweight body milk with 7 AHAs + enzymes — non-comedogenic, no fragrance"}, {"n": "C-Firma Fresh Day Serum", "b": "Drunk Elephant", "c": "Serum", "s": "All", "r": "15% L-ascorbic acid vitamin C, freshness-activated"}, {"n": "Lala Retro Whipped Cream", "b": "Drunk Elephant", "c": "Moisturiser", "s": "Dry,Sensitive,Mature", "r": "6 African oils + ceramides — rich barrier repair without pore-cloggers"}, {"n": "Protini Polypeptide Cream", "b": "Drunk Elephant", "c": "Moisturiser", "s": "Ageing", "r": "Signal peptides + growth factors, zero pore-cloggers"}, {"n": "Shaba Complex Eye Serum", "b": "Drunk Elephant", "c": "Eye Cream", "s": "All", "r": "Copper peptides + kiwi fruit water — firms and brightens under eyes, no pore-clo"}, {"n": "T.L.C. Framboos Glycolic Night Serum", "b": "Drunk Elephant", "c": "Serum", "s": "All", "r": "12% AHA + 2% BHA blend — resurfacing night serum, no pore-cloggers"}, {"n": "T.L.C. Instant Gekko Mask", "b": "Drunk Elephant", "c": "Mask", "s": "Dry,Dehydrated,All", "r": "Moisture-surge mask with marula oil + hyaluronic acid, no pore-cloggers"}, {"n": "T.L.C. Sukari Babyfacial", "b": "Drunk Elephant", "c": "Mask", "s": "All", "r": "25% AHA + 2% BHA weekly treatment, resurfaces skin"}, {"n": "The Cleanser", "b": "Drunk Elephant", "c": "Face Wash", "s": "All", "r": "pH-balanced amino acid cleanser free from the Suspicious 6"}, {"n": "Umbra Sheer Physical Daily Defense SPF 30", "b": "Drunk Elephant", "c": "SPF", "s": "All", "r": "20% zinc oxide sheer mineral SPF — lightweight, non-comedogenic, no white cast"}, {"n": "Umbra Tinte Physical Daily Defense SPF 30", "b": "Drunk Elephant", "c": "Serum", "s": "All,Sensitive,Acne-prone", "r": "Tinted mineral SPF 30 with 20% zinc oxide — lightweight, non-comedogenic"}, {"n": "Cleanser Balm", "b": "Elemis", "c": "Face Wash", "s": "Dry,Mature,All", "r": "Melts into oil to remove makeup — elderberry + starflower, no pore-cloggers"}, {"n": "AM Therapy Facial Moisturizer", "b": "EltaMD", "c": "Moisturiser", "s": "All", "r": "Skincare product by EltaMD"}, {"n": "PM Therapy Facial Moisturizer", "b": "EltaMD", "c": "Moisturiser", "s": "All", "r": "Skincare product by EltaMD"}, {"n": "Skin Recovery Eye and Area Cream", "b": "EltaMD", "c": "Eye Cream", "s": "All", "r": "Skincare product by EltaMD"}, {"n": "UV Clear Broad-Spectrum SPF 46", "b": "EltaMD", "c": "SPF", "s": "All", "r": "Niacinamide + zinc oxide — dermatologist favourite for acne-prone skin"}, {"n": "UV Daily Broad-Spectrum SPF 40", "b": "EltaMD", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 40 — lightweight daily UV protection"}, {"n": "UV Physical Broad-Spectrum SPF 41", "b": "EltaMD", "c": "SPF", "s": "All", "r": "Skincare product by EltaMD"}, {"n": "UV Sport Broad-Spectrum SPF 50", "b": "EltaMD", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Acne Body Lotion", "b": "Face Reality", "c": "Body", "s": "Acne-prone,Body,Oily", "r": "Professional acne-safe body lotion — clears bacne and chest breakouts"}, {"n": "Acne Med 10%", "b": "Face Reality", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Maximum strength benzoyl peroxide treatment — professional acne brand"}, {"n": "Acne Med 5%", "b": "Face Reality", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Professional-grade benzoyl peroxide treatment"}, {"n": "Acne Moisturizer", "b": "Face Reality", "c": "Moisturiser", "s": "Acne-prone,Oily,Combination", "r": "Oil-free, acne-safe moisturizer formulated specifically for breakout-prone skin"}, {"n": "AHA/BHA Exfoliating Cleanser", "b": "Face Reality", "c": "Face Wash", "s": "Oily,Acne-prone,Combination", "r": "Dual-acid professional cleanser — clears congestion at the wash step"}, {"n": "Daily SPF 30 Plus", "b": "Face Reality", "c": "SPF", "s": "Acne-prone,Oily,Combination", "r": "Acne-safe SPF moisturizer combo — oil-free, professional formulation"}, {"n": "Glycolic Serum 10%", "b": "Face Reality", "c": "Serum", "s": "Acne-prone,Oily,Dull", "r": "Professional-strength glycolic acid serum — resurfaces and brightens acne-prone"}, {"n": "Hydrabalance Hydrating Gel", "b": "Face Reality", "c": "Moisturiser", "s": "Oily,Acne-prone,Combination", "r": "Oil-free acne-safe hydrating gel"}, {"n": "Hydracalm Mask", "b": "Face Reality", "c": "Mask", "s": "Dry,Sensitive,Acne-prone", "r": "Professional acne-safe hydrating mask — deeply replenishes without clogging"}, {"n": "Lactic Acid 8%", "b": "Face Reality", "c": "Toner", "s": "Sensitive,Acne-prone,Dry", "r": "Professional lactic acid exfoliant — gentler than glycolic, hydrating while resu"}, {"n": "Mandelic Acid Serum 8%", "b": "Face Reality", "c": "Serum", "s": "Acne-prone,Sensitive", "r": "Professional-grade mandelic acid — gentler than glycolic"}, {"n": "Sulfur Spot Treatment", "b": "Face Reality", "c": "Acne Treatment", "s": "Acne-prone,Sensitive,Oily", "r": "Sulfur-based spot treatment — dries breakouts without over-drying skin"}, {"n": "Ultra Gentle Cleanser", "b": "Face Reality", "c": "Face Wash", "s": "Sensitive,Acne-prone", "r": "Professional acne-safe cleanser, no pore-cloggers"}, {"n": "Eye Duty Triple Remedy AM Gel Cream", "b": "First Aid Beauty", "c": "Eye Cream", "s": "All", "r": "Skincare product by First Aid Beauty"}, {"n": "Face Cleanser", "b": "First Aid Beauty", "c": "Face Wash", "s": "All", "r": "Skincare product by First Aid Beauty"}, {"n": "Hello FAB Coconut Skin Smoothie Priming Moisturizer", "b": "First Aid Beauty", "c": "Moisturiser", "s": "All", "r": "Skincare product by First Aid Beauty"}, {"n": "KP Bump Eraser Body Scrub", "b": "First Aid Beauty", "c": "Body", "s": "All", "r": "Skincare product by First Aid Beauty"}, {"n": "Ultra Repair Cream", "b": "First Aid Beauty", "c": "Moisturiser", "s": "Sensitive", "r": "Colloidal oatmeal + ceramides, instant relief for dry skin"}, {"n": "Ultra Repair Face Moisturizer", "b": "First Aid Beauty", "c": "Moisturiser", "s": "Sensitive,Dry,Acne-prone", "r": "Colloidal oatmeal + ceramides, fragrance-free, acne-safe"}, {"n": "Ultra Repair Tinted Moisturizer SPF 30", "b": "First Aid Beauty", "c": "SPF", "s": "Sensitive", "r": "Broad-spectrum SPF 30 — daily UV protection"}, {"n": "Ultra Repair Wild Oat Hydrating Toner", "b": "First Aid Beauty", "c": "Toner", "s": "Sensitive", "r": "Skincare product by First Aid Beauty"}, {"n": "Invisible Shield Daily Sunscreen SPF 35", "b": "Glossier", "c": "SPF", "s": "All,Oily,Combination", "r": "Water-gel texture, no white cast, non-comedogenic"}, {"n": "Milky Jelly Cleanser", "b": "Glossier", "c": "Face Wash", "s": "All,Sensitive", "r": "5 skin conditioners in a gentle pH-balanced formula"}, {"n": "Priming Moisturizer", "b": "Glossier", "c": "Moisturiser", "s": "All,Normal,Combination", "r": "Skin-blurring lightweight daily moisturizer"}, {"n": "Avocado Ceramide Recovery Serum", "b": "Glow Recipe", "c": "Serum", "s": "Dull", "r": "Ceramides + hyaluronic acid — barrier repair and 24hr hydration"}, {"n": "Banana Soufflé Moisture Cream", "b": "Glow Recipe", "c": "Moisturiser", "s": "Dull", "r": "Skincare product by Glow Recipe"}, {"n": "Cloudberry Bright SPF 50 Sunscreen", "b": "Glow Recipe", "c": "SPF", "s": "Dull", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Future Dew Serum", "b": "Glow Recipe", "c": "Serum", "s": "Oily,Combination,Normal", "r": "Hyaluronic + niacinamide + bakuchiol, weightless glass-skin serum"}, {"n": "Plum Plump Hyaluronic Acid Serum", "b": "Glow Recipe", "c": "Serum", "s": "Dull", "r": "Hyaluronic acid — deep hydration and plumping for all skin types"}, {"n": "Strawberry Smooth BHA+AHA Salicylic Serum", "b": "Glow Recipe", "c": "Serum", "s": "Acne-prone,Oily,Dull", "r": "Skincare product by Glow Recipe"}, {"n": "Watermelon Glow Niacinamide Dew Drops", "b": "Glow Recipe", "c": "Serum", "s": "Dull", "r": "Niacinamide — pore-minimising, brightening, and barrier-supporting"}, {"n": "Watermelon Glow PHA+BHA Pore-Tight Toner", "b": "Glow Recipe", "c": "Toner", "s": "Acne-prone,Oily,Dull", "r": "Skincare product by Glow Recipe"}, {"n": "Watermelon Glow Sleeping Mask", "b": "Glow Recipe", "c": "Mask", "s": "Dull", "r": "Overnight watermelon + AHA brightening sleep mask"}, {"n": "Invisible Pimple Patches", "b": "Hero Cosmetics", "c": "Acne Treatment", "s": "Acne-prone,All", "r": "Hydrocolloid patches absorb pus, protect from bacteria, no ingredients to worry"}, {"n": "Green Tea Seed Serum", "b": "Innisfree", "c": "Serum", "s": "All,Oily,Combination", "r": "Jeju green tea antioxidants, 5-layer hydration"}, {"n": "Calendula Herbal-Extract Toner", "b": "Kiehl's", "c": "Toner", "s": "All,Sensitive", "r": "Alcohol-free calendula toner, soothes and balances"}, {"n": "Clearly Corrective Dark Spot Corrector", "b": "Kiehl's", "c": "Serum", "s": "All,Dull,Post-acne", "r": "White birch + peony extract fades post-acne marks, non-comedogenic"}, {"n": "Creamy Eye Treatment with Avocado", "b": "Kiehl's", "c": "Eye Cream", "s": "Dry,Mature", "r": "Rich avocado eye cream, deeply nourishing"}, {"n": "Ultra Facial Cream", "b": "Kiehl's", "c": "Moisturiser", "s": "All,Dry,Normal", "r": "24hr hydration, squalane + glacial glycoprotein"}, {"n": "Anthelios Clear Skin SPF 60", "b": "La Roche-Posay", "c": "SPF", "s": "All", "r": "Skincare product by La Roche-Posay"}, {"n": "Anthelios Melt-in Milk Sunscreen SPF 60", "b": "La Roche-Posay", "c": "SPF", "s": "All", "r": "Skincare product by La Roche-Posay"}, {"n": "Cicaplast Baume B5", "b": "La Roche-Posay", "c": "Moisturiser", "s": "Sensitive", "r": "Cica (centella) — calming redness and repairing skin barrier"}, {"n": "Cicaplast Baume B5+", "b": "La Roche-Posay", "c": "Moisturiser", "s": "Sensitive,Dry,Damaged", "r": "Panthenol + madecassoside repair balm — dermatologist go-to for barrier recovery"}, {"n": "Effaclar Clarifying Solution Toner", "b": "La Roche-Posay", "c": "Toner", "s": "All", "r": "Skincare product by La Roche-Posay"}, {"n": "Effaclar Duo Acne Treatment", "b": "La Roche-Posay", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Skincare product by La Roche-Posay"}, {"n": "Effaclar Medicated Gel Cleanser", "b": "La Roche-Posay", "c": "Face Wash", "s": "All", "r": "Skincare product by La Roche-Posay"}, {"n": "Effaclar Purifying Foaming Gel", "b": "La Roche-Posay", "c": "Face Wash", "s": "Oily,Acne-prone", "r": "Zinc + LHA target congestion without stripping"}, {"n": "Hyalu B5 Pure Hyaluronic Acid Serum", "b": "La Roche-Posay", "c": "Serum", "s": "All", "r": "Hyaluronic acid — deep hydration and plumping for all skin types"}, {"n": "Retinol B3 Serum", "b": "La Roche-Posay", "c": "Serum", "s": "Ageing", "r": "Retinol — anti-ageing, smooths texture and reduces fine lines"}, {"n": "Toleriane Double Repair Face Moisturizer", "b": "La Roche-Posay", "c": "Moisturiser", "s": "Sensitive", "r": "Skincare product by La Roche-Posay"}, {"n": "Toleriane Hydrating Gentle Cleanser", "b": "La Roche-Posay", "c": "Face Wash", "s": "Sensitive", "r": "Fragrance-free, microbiome-friendly, no pore-cloggers"}, {"n": "Toleriane Sensitive Fluide", "b": "La Roche-Posay", "c": "Moisturiser", "s": "Sensitive", "r": "Skincare product by La Roche-Posay"}, {"n": "Toleriane Ultra Eye Cream", "b": "La Roche-Posay", "c": "Eye Cream", "s": "Sensitive", "r": "Skincare product by La Roche-Posay"}, {"n": "Lip Sleeping Mask", "b": "Laneige", "c": "Mask", "s": "All", "r": "Overnight lip mask repairs and plumps while you sleep"}, {"n": "Water Sleeping Mask", "b": "Laneige", "c": "Moisturiser", "s": "All,Dry,Normal", "r": "Overnight hydration boost, SLEEPSCENT technology"}, {"n": "Drying Lotion", "b": "Mario Badescu", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Cult overnight spot treatment, dries blemishes fast"}, {"n": "Facial Spray with Aloe", "b": "Mario Badescu", "c": "Toner", "s": "All,Dry", "r": "Refreshing aloe mist, sets makeup and hydrates"}, {"n": "Acne Cleanser", "b": "Murad", "c": "Face Wash", "s": "Acne-prone,Oily", "r": "1.5% salicylic acid + glycolic acid, dermatologist developed"}, {"n": "Acne Spot Treatment", "b": "Murad", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "2% salicylic acid + sulfur, dries blemishes overnight"}, {"n": "Supercharged Moisture Cream", "b": "Murad", "c": "Moisturiser", "s": "All,Dry,Mature", "r": "Hyaluronic acid trilogy + retinol alternative, acne-safe formula"}, {"n": "Barrier+ Moisturizer", "b": "Naturium", "c": "Moisturiser", "s": "Sensitive,Dry,All", "r": "Ceramide + peptide barrier moisturizer — fragrance-free, non-comedogenic"}, {"n": "Bright Eyes Illuminating Eye Cream", "b": "Naturium", "c": "Eye Cream", "s": "All,Dark Circles,Puffiness", "r": "Caffeine + niacinamide + peptides — brightens dark circles, non-comedogenic"}, {"n": "Jelly Facial Cleanser", "b": "Naturium", "c": "Face Wash", "s": "All,Oily,Combination", "r": "Gentle glycerin-based jelly cleanser, fragrance-free, no pore-cloggers"}, {"n": "Naturium Azelaic Acid Emulsion 10%", "b": "Naturium", "c": "Acne Treatment", "s": "Acne-prone,Redness,Sensitive", "r": "10% azelaic acid fades marks and calms redness, acne-safe base"}, {"n": "Bright Boost Micro-Polish Exfoliating Cleanser", "b": "Neutrogena", "c": "Toner", "s": "All", "r": "Skincare product by Neutrogena"}, {"n": "Healthy Skin Anti-Wrinkle Night Cream", "b": "Neutrogena", "c": "Moisturiser", "s": "Ageing", "r": "Skincare product by Neutrogena"}, {"n": "Hydro Boost Eye Gel Cream", "b": "Neutrogena", "c": "Eye Cream", "s": "All,Oily", "r": "Lightweight hyaluronic gel, non-comedogenic eye cream"}, {"n": "Mineral Ultra Sheer Sunscreen SPF 70", "b": "Neutrogena", "c": "SPF", "s": "All", "r": "Skincare product by Neutrogena"}, {"n": "Oil-Free Acne Wash", "b": "Neutrogena", "c": "Face Wash", "s": "Acne-prone,Oily", "r": "Skincare product by Neutrogena"}, {"n": "Oil-Free Moisture Broad Spectrum SPF 35", "b": "Neutrogena", "c": "Moisturiser", "s": "Oily,Acne-prone,Combination", "r": "Oil-free moisturizer with SPF 35, non-comedogenic"}, {"n": "Rapid Wrinkle Repair Retinol Serum", "b": "Neutrogena", "c": "Serum", "s": "Sensitive,Ageing", "r": "Retinol — anti-ageing, smooths texture and reduces fine lines"}, {"n": "Stubborn Acne AM Treatment", "b": "Neutrogena", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "Skincare product by Neutrogena"}, {"n": "Ultra Sheer Dry-Touch Sunscreen SPF 100", "b": "Neutrogena", "c": "SPF", "s": "Dry", "r": "Skincare product by Neutrogena"}, {"n": "Ultra Sheer Dry-Touch Sunscreen SPF 55", "b": "Neutrogena", "c": "SPF", "s": "All,Oily,Combination", "r": "Lightweight, non-greasy, non-comedogenic SPF 55"}, {"n": "10% Azelaic Acid Booster", "b": "Paula's Choice", "c": "Toner", "s": "Acne-prone,Redness,Hyperpigmentation", "r": "Azelaic acid fades marks and reduces redness"}, {"n": "10% Niacinamide Booster", "b": "Paula's Choice", "c": "Serum", "s": "Oily,Acne-prone,Combination", "r": "Pure 10% niacinamide serum — pore-minimizing, oil control"}, {"n": "BOOST C15 Super Booster", "b": "Paula's Choice", "c": "Serum", "s": "All", "r": "Skincare product by Paula's Choice"}, {"n": "CLEAR Pore Normalizing Cleanser", "b": "Paula's Choice", "c": "Face Wash", "s": "Acne-prone,Oily", "r": "Skincare product by Paula's Choice"}, {"n": "CLEAR Regular Strength Daily Skin Clearing Treatment", "b": "Paula's Choice", "c": "Acne Treatment", "s": "All", "r": "Skincare product by Paula's Choice"}, {"n": "RESIST Anti-Aging Eye Gel", "b": "Paula's Choice", "c": "Eye Cream", "s": "Ageing", "r": "Skincare product by Paula's Choice"}, {"n": "RESIST Hyaluronic Acid Booster", "b": "Paula's Choice", "c": "Serum", "s": "All", "r": "Hyaluronic acid — deep hydration and plumping for all skin types"}, {"n": "SKIN BALANCING Ultra-Sheer Daily Defense SPF 30", "b": "Paula's Choice", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 30 — daily UV protection"}, {"n": "Skin Perfecting 8% AHA Gel Exfoliant", "b": "Paula's Choice", "c": "Toner", "s": "All", "r": "Skincare product by Paula's Choice"}, {"n": "SKIN RECOVERY Replenishing Moisturizer", "b": "Paula's Choice", "c": "Moisturiser", "s": "All", "r": "Skincare product by Paula's Choice"}, {"n": "Cucumber Gel Mask", "b": "Peter Thomas Roth", "c": "Mask", "s": "All,Sensitive,Oily", "r": "Cooling cucumber gel mask soothes and hydrates"}, {"n": "AOX+ Eye Gel", "b": "SkinCeuticals", "c": "Eye Cream", "s": "All", "r": "Skincare product by SkinCeuticals"}, {"n": "C E Ferulic", "b": "SkinCeuticals", "c": "Serum", "s": "All,Mature,Dull", "r": "Gold standard vitamin C serum, 15% L-ascorbic acid"}, {"n": "HA Intensifier", "b": "SkinCeuticals", "c": "Serum", "s": "All,Mature", "r": "Supports HA synthesis in skin, clinical-grade"}, {"n": "Hydrating B5 Gel", "b": "SkinCeuticals", "c": "Serum", "s": "All", "r": "Skincare product by SkinCeuticals"}, {"n": "Physical Fusion UV Defense SPF 50", "b": "SkinCeuticals", "c": "SPF", "s": "All", "r": "100% mineral SPF 50, tinted for all skin tones"}, {"n": "Phyto Corrective Gel", "b": "SkinCeuticals", "c": "Serum", "s": "All", "r": "Skincare product by SkinCeuticals"}, {"n": "Retinol 0.3", "b": "SkinCeuticals", "c": "Serum", "s": "Ageing", "r": "Retinol — anti-ageing, smooths texture and reduces fine lines"}, {"n": "Simply Clean Gel Cleanser", "b": "SkinCeuticals", "c": "Face Wash", "s": "All", "r": "Skincare product by SkinCeuticals"}, {"n": "Triple Lipid Restore 2:4:2", "b": "SkinCeuticals", "c": "Moisturiser", "s": "All", "r": "Skincare product by SkinCeuticals"}, {"n": "Daily Physical Defense SPF 30", "b": "SkinMedica", "c": "SPF", "s": "All,Sensitive,Mature", "r": "Derm-developed mineral SPF — antioxidant-rich, non-comedogenic"}, {"n": "HA5 Rejuvenate Hydrator", "b": "SkinMedica", "c": "Moisturiser", "s": "All,Dry,Mature", "r": "5 forms of hyaluronic acid — plumping, non-comedogenic, derm staple"}, {"n": "Lytera 2.0 Pigment Correcting Serum", "b": "SkinMedica", "c": "Serum", "s": "All,Dull,Post-acne,Hyperpigmentation", "r": "Tranexamic acid + niacinamide — derm gold standard for stubborn dark spots"}, {"n": "Retinol Complex Eye Cream", "b": "SkinMedica", "c": "Eye Cream", "s": "Mature,All", "r": "Derm-developed retinol eye cream — smooths crow's feet, non-comedogenic"}, {"n": "Soothe Cleansing Milk", "b": "SkinMedica", "c": "Face Wash", "s": "Sensitive,Dry,Mature", "r": "Derm-developed milky cleanser — calms and hydrates while cleansing"}, {"n": "TNS Advanced+ Serum", "b": "SkinMedica", "c": "Moisturiser", "s": "Mature,All,Dull", "r": "Growth factor serum — clinically proven to reduce fine lines, non-comedogenic"}, {"n": "TNS Eye Repair", "b": "SkinMedica", "c": "Serum", "s": "Mature,All", "r": "Growth factors + retinol for the eye area — derm-developed, non-comedogenic"}, {"n": "Ultra Sheer Micro-Exfoliating Lotion", "b": "SkinMedica", "c": "Toner", "s": "All,Acne-prone,Dull", "r": "AHA/BHA blend in a derm-developed exfoliating lotion — non-comedogenic"}, {"n": "AHA BHA PHA 30 Days Miracle Foam Cleanser", "b": "Some By Mi", "c": "Face Wash", "s": "Oily,Acne-prone,Combination", "r": "Triple acid cleanser — clears congestion gently"}, {"n": "AHA BHA PHA 30 Days Miracle Toner", "b": "Some By Mi", "c": "Toner", "s": "Acne-prone,Oily,Combination", "r": "Triple acid toner clears pores and refines texture"}, {"n": "Apricot Scrub", "b": "St. Ives", "c": "Body", "s": "Normal,Combination", "r": "Exfoliating scrub with 100% natural walnut shell powder"}, {"n": "C.E.O. 15% Vitamin C Brightening Serum", "b": "Sunday Riley", "c": "Serum", "s": "All,Dull,Mature", "r": "THD vitamin C + turmeric, brightens and firms skin"}, {"n": "Good Genes All-In-One Lactic Acid Treatment", "b": "Sunday Riley", "c": "Serum", "s": "All,Dull,Uneven", "r": "Lactic acid exfoliant with licorice, instant glow"}, {"n": "The Dewy Skin Cream", "b": "Tatcha", "c": "Moisturiser", "s": "All", "r": "Skincare product by Tatcha"}, {"n": "The Essence Skincare Plumping Treatment", "b": "Tatcha", "c": "Toner", "s": "All", "r": "Skincare product by Tatcha"}, {"n": "The Indigo Cream Soothing Skin Barrier Moisturizer", "b": "Tatcha", "c": "Moisturiser", "s": "Sensitive", "r": "Skincare product by Tatcha"}, {"n": "The Luminous Dewy Skin Mist", "b": "Tatcha", "c": "Toner", "s": "All", "r": "Skincare product by Tatcha"}, {"n": "The Rice Wash Skin-Softening Cleanser", "b": "Tatcha", "c": "Face Wash", "s": "All", "r": "Skincare product by Tatcha"}, {"n": "The Serum Stick Targeted Wrinkle Treatment", "b": "Tatcha", "c": "Serum", "s": "Ageing", "r": "Skincare product by Tatcha"}, {"n": "The Water Cream", "b": "Tatcha", "c": "Moisturiser", "s": "All", "r": "Oil-free water-burst moisturizer, Japanese botanicals"}, {"n": "AHA 30% + BHA 2% Peeling Solution", "b": "The Ordinary", "c": "Toner", "s": "Acne-prone,Oily", "r": "10min weekly peel — resurfaces and unclogs in one step"}, {"n": "Alpha Arbutin 2% + HA", "b": "The Ordinary", "c": "Serum", "s": "All", "r": "Brightening alpha arbutin, reduces dark spots"}, {"n": "Azelaic Acid Suspension 10%", "b": "The Ordinary", "c": "Acne Treatment", "s": "All", "r": "Azelaic acid — reduces blemishes, redness, and hyperpigmentation"}, {"n": "Buffet Multi-Technology Peptide Serum", "b": "The Ordinary", "c": "Serum", "s": "Ageing", "r": "Peptide complex — firms, plumps, and reduces signs of ageing"}, {"n": "Caffeine Solution 5% + EGCG", "b": "The Ordinary", "c": "Serum", "s": "All", "r": "Reduces puffiness and dark circles under eyes"}, {"n": "Glycolic Acid 7% Toning Solution", "b": "The Ordinary", "c": "Toner", "s": "All", "r": "Daily glycolic toner improves texture and brightness"}, {"n": "Hyaluronic Acid 2% + B5", "b": "The Ordinary", "c": "Serum", "s": "All", "r": "Multi-weight HA complex, deep and surface hydration"}, {"n": "Lactic Acid 10% + HA", "b": "The Ordinary", "c": "Toner", "s": "All", "r": "Lactic acid — gentle exfoliant for brighter, smoother skin"}, {"n": "Natural Moisturizing Factors + HA", "b": "The Ordinary", "c": "Moisturiser", "s": "All", "r": "Skincare product by The Ordinary"}, {"n": "Retinal 0.2% Eye Cream", "b": "The Ordinary", "c": "Serum", "s": "All,Mature,Acne-prone", "r": "Retinaldehyde — 11x more potent than retinol, stable formula"}, {"n": "Retinol 0.5% in Squalane", "b": "The Ordinary", "c": "Serum", "s": "Ageing", "r": "Stable retinol in squalane — anti-acne and anti-aging"}, {"n": "Salicylic Acid 2% Anhydrous Solution", "b": "The Ordinary", "c": "Acne Treatment", "s": "Acne-prone,Oily", "r": "2% salicylic acid — unclogs pores and clears blemishes"}, {"n": "Vitamin C Suspension 23% + HA 2%", "b": "The Ordinary", "c": "Serum", "s": "Dull", "r": "Vitamin C — antioxidant brightening and dark spot correction"}, {"n": "Vitamin C Suspension 23% + HA Spheres 2%", "b": "The Ordinary", "c": "Serum", "s": "All,Dull", "r": "High-strength vitamin C suspension, brightening powerhouse"}, {"n": "SOS Daily Rescue Facial Spray", "b": "Tower 28", "c": "Toner", "s": "All", "r": "Skincare product by Tower 28"}, {"n": "MakeWaves Scalp + Body Serum", "b": "Tower 28", "c": "Acne Treatment", "s": "Acne-prone,Sensitive,Body", "r": "Hypochlorous acid for scalp and body — anti-inflammatory, SkinSafe certified"}, {"n": "Waterfacial Moisturizer", "b": "Tower 28", "c": "Moisturiser", "s": "Sensitive,Oily,Acne-prone", "r": "Lightweight gel moisturizer — SkinSafe certified, NEA eczema seal, zero fragranc"}, {"n": "Creamy Skin Cleanser", "b": "Vanicream", "c": "Face Wash", "s": "Sensitive,Dry,Eczema", "r": "Free of all common irritants — cleanser for reactive skin"}, {"n": "Gentle Body Wash", "b": "Vanicream", "c": "Body", "s": "Sensitive,Dry,Eczema", "r": "Free of all common irritants, gentle daily body wash"}, {"n": "Daily Facial Moisturizer", "b": "Vanicream", "c": "Moisturiser", "s": "All", "r": "Skincare product by Vanicream"}, {"n": "Gentle Facial Wash", "b": "Vanicream", "c": "Face Wash", "s": "Sensitive", "r": "Skincare product by Vanicream"}, {"n": "Lite Lotion", "b": "Vanicream", "c": "Moisturiser", "s": "All", "r": "Skincare product by Vanicream"}, {"n": "Moisturizing Skin Cream", "b": "Vanicream", "c": "Moisturiser", "s": "All", "r": "Skincare product by Vanicream"}, {"n": "Moisturizing Sunscreen SPF 50", "b": "Vanicream", "c": "SPF", "s": "All", "r": "Broad-spectrum SPF 50 — daily UV protection"}, {"n": "Retinol Eye Cream", "b": "Vanicream", "c": "Eye Cream", "s": "Ageing", "r": "Retinol — anti-ageing, smooths texture and reduces fine lines"}, {"n": "Bright On Mask Vitamin C", "b": "Versed", "c": "Mask", "s": "All,Dull,Acne-prone", "r": "Vitamin C + niacinamide glow mask — clean, acne-safe formula"}, {"n": "Jelly Cleanser", "b": "Versed", "c": "Face Wash", "s": "All,Acne-prone,Sensitive", "r": "Clean, fragrance-free, pore-safe jelly formula"}, {"n": "Press Restart Gentle Retinol Serum", "b": "Versed", "c": "Serum", "s": "All,Acne-prone,Mature", "r": "0.1% retinol encapsulated for slow release — acne-safe, gentle"}, {"n": "Stressed? Balancing Gel Cream", "b": "Versed", "c": "Moisturiser", "s": "Oily,Combination,Acne-prone", "r": "Oil-free, non-comedogenic, niacinamide-forward"}, {"n": "Adaptogen Deep Moisture Serum", "b": "Youth To The People", "c": "Serum", "s": "All,Stressed,Acne-prone", "r": "Ashwagandha + reishi mushroom + hyaluronic acid — zero pore-cloggers"}, {"n": "Clearing + Live Kombucha Tonic", "b": "Youth To The People", "c": "Mask", "s": "Acne-prone,Oily,Combination", "r": "Live kombucha + niacinamide + willow bark, microbiome-balancing toner"}, {"n": "Superfluid UV Defense SPF 50+ Moisturizer", "b": "Youth To The People", "c": "Moisturiser", "s": "Oily,Combination,Acne-prone", "r": "100% mineral SPF moisturizer — kale + adaptogen complex, zero pore-cloggers"}, {"n": "Supergreens Facial Mask", "b": "Youth To The People", "c": "Mask", "s": "All,Oily,Acne-prone", "r": "Kale + spirulina + hyaluronic acid — detoxifying without stripping"}].map(d => ({
    productName: d.n, brand: d.b, category: d.c,
    skinTypes: d.s, reason: d.r
  }));
}
...
function AdminNuclearClean({ onBack }) {
  ...
  function isJunk(productName, brand) {
    ...
    const JUNK = ["cera quente","cera fria","cera depilat","depiroll","depi roll","tampax",
      "lingette bebe","dentifrice","gaviscon","nanuk","bodyspray","shampooing","shampoing",
      "après-shampooing","mascarilla de pelo","elseve color","ultra doux shamp","gliss shamp",
      "violet déjaunisseur","68yn5t","mixa bébé","creme öl dusche","baby öl","cera di cupra",
      "cera para cabelo","baume après-rasage","cloro de","savon bouton","axe dark","pintalabios",
      "cera brillo","cera en gel","cera cabello","stick lèvres anti","masque nutritif technique",
      "anti fungal trick","anti bacterial trick","squid fur","olay shave gel","olay regenerist nghit",
      "deep润","čokoládovo","lingettes famil","l'oréal espresso","soin global crème jour",
      "crème pour la peau cien","palette intensive","formule 2 en 1","ph5 lait","créme activ nelly",
      "body shampoo cocooning","vlcc 3d","johnson2","johnsons sensitive shampoo","clear men herbal",
      "fast clear garnier","neutrogena soothing clear","solution micellaire skincactive",
      "bb clear","get real face","cera ve baby","vanicream soap","olay total effect",
      "essence ultîme diamond","herbal essences real botanicals"];
    return JUNK.some(p => combo.includes(p));
  }
  ...
  async function runNuclearClean() {
    ...
    // Load seed data from our curated list
    const seedData = await getNuclearSeedProducts();
    addLog(`Loaded ${seedData.length} seed products`,"info");
